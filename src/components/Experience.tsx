...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="relative z-10 w-full bg-[#0C0C0C] py-20 md:py-28 border-t border-accentBorder/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-full border border-sky-400/30 bg-sky-500/10 flex items-center justify-center text-sky-400 shrink-0">
                <Briefcase size={20} />
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase text-lightText tracking-wide leading-normal py-1">
                Work Experience
              </h2>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-full border border-emerald-400/30 bg-emerald-500/10 flex items-center justify-center text-emerald-400 shrink-0">
